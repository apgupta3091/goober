...
type RideShare struct {
	...
	PriceInCents  float64                `protobuf:"fixed64,4,opt,name=priceInCents,proto3" json:"priceInCents,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RideShare) GetPriceInCents() float64 {
	if x != nil {
...
const file_trip_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"trip.proto\x12\x04trip\x1a google/protobuf/descriptor.proto\"\x98\x01\n" +
	...
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"y\n" +
	"\tRideShare\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06userID\x18\x02 \x01(\tR\x06userID\x12 \n" +
	"\vpackageSlug\x18\x03 \x01(\tR\vpackageSlug\x12\"\n" +
	"\fpriceInCents\x18\x04 \x01(\x01R\fpriceInCents2Q\n" +
	"\vTripService\x12B\n" +
